      ...
      <Box sx={{ display: 'flex',paddingLeft:'20vw', paddingBottom:'3vh'}}>
        ...
        >
          ...
          >
            ...
            <Typography variant="h4" sx={{ fontFamily: 'Orbitron', marginBottom: '1rem', color:'white' }}> Director: {data.director}</Typography>
            ...
            <Typography variant="h5" sx={{ fontFamily: 'Orbitron', marginBottom: '1rem', color:'white' }}> Email-Director: {data.directorEmail}</Typography>
            <Typography variant="h5" sx={{ fontFamily: 'Orbitron', marginBottom: '1rem', color:'white' }}> Fecha de Inicio: {data.fechaInicio}</Typography>
            <Typography variant="h5" sx={{ fontFamily: 'Orbitron', marginBottom: '1rem', color:'white' }}> Fecha de Fin: {data.fechaFin}</Typography>
            <Typography variant="h5" sx={{ fontFamily: 'Orbitron', marginBottom: '1rem', color:'white' }}> Etapa: {data.etapa}</Typography>
          </Grid>
          <Grid
            sx={{
              display: 'flex',
